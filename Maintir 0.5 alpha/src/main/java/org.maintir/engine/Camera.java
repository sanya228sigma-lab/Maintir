...
public class Camera {
    ...
    public void updateInput(long window, float deltaTime) {
        ...
        if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS) position.add(new Vector3f(front).mul(speed));
        if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS) position.sub(new Vector3f(front).mul(speed));
        if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS) position.sub(new Vector3f(right).mul(speed));
        if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS) position.add(new Vector3f(right).mul(speed));
